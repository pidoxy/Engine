...
export const LANGUAGES: Record<LanguageCode, Language> = {
  ...
  ha: {
    ...
    whisperCode: 'ha',
    elevenLabsVoiceId: process.env.NEXT_PUBLIC_VOICE_HA || 'EXAVITQu4vr4xnSDxMaL',
    accentColor: '#10b981',
  ...
  yo: {
    ...
    whisperCode: 'yo',
    elevenLabsVoiceId: process.env.NEXT_PUBLIC_VOICE_YO || 'EXAVITQu4vr4xnSDxMaL',
    accentColor: '#7c3aed',
  ...
  ig: {
    ...
    whisperCode: 'ig',
    elevenLabsVoiceId: process.env.NEXT_PUBLIC_VOICE_IG || 'EXAVITQu4vr4xnSDxMaL',
    accentColor: '#dc2626',
  ...
  pcm: {
    ...
    elevenLabsVoiceId: process.env.NEXT_PUBLIC_VOICE_PCM || 'EXAVITQu4vr4xnSDxMaL',
    accentColor: '#d97706',
