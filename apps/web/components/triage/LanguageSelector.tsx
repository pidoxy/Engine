...
import { LanguageCode } from '@/lib/triage/types';
import { LANGUAGES, LANGUAGE_ORDER } from '@/lib/triage/languages';
import BrandingHeader from '@/components/triage/BrandingHeader';
import BrandingFooter from '@/components/triage/BrandingFooter';
