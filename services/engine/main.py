...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:3001",
        "http://localhost:3001",
        "https://theaidcare.com",             # Main app (theaidcare.com frontend)
        "https://www.theaidcare.com",         # www variant
        "https://triage.theaidcare.com",      # Triage PWA subdomain
        "https://lang.theaidcare.com",        # Multilingual subdomain
        "https://aidcare-lang.vercel.app",    # Vercel preview for lang app
        "https://aidcare-copilot.vercel.app", # Copilot (separate project)
    ],
